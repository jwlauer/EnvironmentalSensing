...
To make it easy to break out of the program, it waits a little longer
at the end of the program when a tip/reset occurs.  

Be sure to set the correct SSID, password and keys to the Google App Script
and Google Sheet.
